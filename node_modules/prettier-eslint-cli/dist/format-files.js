...
function formatFilesFromArgv(_ref) {
  var fileGlobs = _ref._,
      ...
      _logLevel = _ref["log-level"],
      _logLevelAlias = _ref.l,
      listDifferent = _ref.listDifferent,
      _listDifferent = _ref["list-different"],
      stdin = _ref.stdin,
      stdinFilepath = _ref.stdinFilepath,
      _stdinFilepath = _ref["stdin-filepath"],
      write = _ref.write,
      eslintPath = _ref.eslintPath,
      _eslintPath = _ref["eslint-path"],
      prettierPath = _ref.prettierPath,
      _prettierPath = _ref["prettier-path"],
      ...
      _eslintIgnore = _ref["eslint-ignore"],
      eslintConfigPath = _ref.eslintConfigPath,
      _eslintConfigPath = _ref["eslint-config-path"],
      prettierLast = _ref.prettierLast,
      _prettierLast = _ref["prettier-last"],
      prettierOptions = (0, _objectWithoutProperties3.default)(_ref, ["_", "$0", "help", "h", "version", "logLevel", "log-level", "l", "listDifferent", "list-different", "stdin", "stdinFilepath", "stdin-filepath", "write", "eslintPath", "eslint-path", "prettierPath", "prettier-path", "ignore", "eslintIgnore", "eslint-ignore", "eslintConfigPath", "eslint-config-path", "prettierLast", "prettier-last"]);
...
function formatFilesFromGlobs(fileGlobs, ignoreGlobs, cliOptions, prettierESLintOptions, applyEslintIgnore) {
  ...
  return new Promise(function (resolve) {
    ...
    var failures = [];
    var unchanged = [];
    _rxjs.Observable.from(fileGlobs).mergeMap(getFilesFromGlob.bind(null, ignoreGlobs, applyEslintIgnore), null, concurrentGlobs).concatAll().distinct().mergeMap(filePathToFormatted, null, concurrentFormats).subscribe(onNext, onError, onComplete);
...
function formatFile(filePath, prettierESLintOptions, cliOptions) {
  ...
  return format$.catch(function (error) {
    ...
    return _rxjs.Observable.of(Object.assign(fileInfo, { error }));
  });
}
